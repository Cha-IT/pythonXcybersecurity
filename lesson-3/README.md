...
2. **Python Power-Up:** Functions & Modules
3. **Hashing:** One-way streets (MD5, SHA-256)
4. **Encryption:** Locking and Unlocking with `cryptography`
5. **Project:** Building a Password Vault
6. **Real-World Failures:** LinkedIn & RockYou

## Setup
You will need the `cryptography` library for this lesson.
```bash
